...
export async function listAllSessionHtmls() {
  const result = await db.select({
    id: schema.sessions.id,
    html: schema.sessions.html,
  }).from(schema.sessions);
  return result;
}
